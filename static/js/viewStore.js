...
const roomDoc = firestore.doc(db, “rooms”, currentRoom);
try {
const saveData = { cards, ts, _updated: firestore.serverTimestamp() };
if (pdfUrl) saveData.pdfUrl = pdfUrl;
await firestore.setDoc(liveDoc, saveData, { merge: true });
